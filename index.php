...
if (isset($_SESSION['login']) && isset($_SESSION['login']['email'])) {

    header('Location:/Sneaker');

}
global $conn;
$result = mysqli_query($conn, "SELECT * FROM t_user");
        ...
        <div class="header">
            <div class="header-content clearfix">
                ...
                <div class="header-right">
                    <ul class="clearfix">
                        <li class="icons dropdown"><a href="./assets/javascript:void(0)" data-toggle="dropdown">
                        ...
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                            <a href="./assets/app-profile.html"><i class="icon-user"></i> <span>Profile</span></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void()">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./assets/layout-fixed-sidebar.html">Fixed Sidebar</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="./assets/widgets.html" aria-expanded="false">
